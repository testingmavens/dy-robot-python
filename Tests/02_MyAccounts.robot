...
*** Test Cases ***
PRD_SMK_MyAcount - 01 - Add/Edit/Remove Address details and card details
    [Tags]
    Click on Sign In
...
PRD_SMK_MyAcount - 02 -Add/Edit/Remove card details
    [Tags]  ${product}
    Click on Sign In
    Click on Register User
    Close the Get the First Look modal
...
PRD_SMK_MyAcount - 03 - Validate Personal Info change
    [Tags]  ${product}
    Click on Sign In
    Click on Register User
    Close the Get the First Look modal
